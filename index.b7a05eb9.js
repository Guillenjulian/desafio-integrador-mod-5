...
},{"./router":"4QFWt","./componet/button/index":"2paZq","./componet/text-init/index":"bRr5Y","./componet/mano-papel/index":"bda4w","./componet/mano-piedra/index":"e5Vdc","./componet/mano-tijera/index":"kgzbz","./componet/text-rules/index":"gGFc6","./componet/contador/index":"8bBHG","./state":"1Yeju","./componet/card-result":"j54jn"}],"4QFWt":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./pages/page-welcome":"2yfqv","./pages/play":"hbEIY","./pages/reglas":"1qZI2","./pages/result":"7wfLH"}],"gkKU3":[function(require,module,exports) {
...
},{}],"2yfqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
.mano-piedra:hover{
  ...
  `;
    ...
    const pcPiedraEl = div.querySelector(".pc-papel");
    ...
    const removetijerasclick = ()=>{
        ...
        setTimeout(()=>{
            ...
            else if ((0, _state.state).data.currentGame.cpuPlay == "piedra") manoPiedraEl.style.display = "flex";
            else if ((0, _state.state).data.currentGame.cpuPlay == "papel") manoPapelEl.style.display = "flex";
...
.contenedor {
  ...
  `;
    ...
    function handel() {
        ...
        else if (result === "Perdiste") starCmon.style.backgroundColor = "red";
        else if (result === "Empate") starCmon.style.backgroundColor = "yellow";
    }
    div.appendChild(style);
    handleClick();
    handel();
...
},{"3417c22d32176c0b":"iXApR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iXApR":[function(require,module,exports) {
module.exports = require("559fb1cce55f32bd").getBundleURL("aNMIV") + "papel.14724006.png" + "?" + Date.now();

},{"559fb1cce55f32bd":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{"9954fda1ff7d2ee3":"9tl6U","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9tl6U":[function(require,module,exports) {
module.exports = require("a55dd3f343739a7f").getBundleURL("aNMIV") + "piedra.dea56516.png" + "?" + Date.now();

},{"a55dd3f343739a7f":"lgJ39"}],"kgzbz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init);
function init() {
...
},{"2772710958df8c62":"GlzFt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"GlzFt":[function(require,module,exports) {
module.exports = require("b868947009622aff").getBundleURL("aNMIV") + "tijera.1073e9d6.png" + "?" + Date.now();

},{"b868947009622aff":"lgJ39"}],"gGFc6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initRules", ()=>initRules);
function initRules() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8bBHG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init);
function init() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../state":"1Yeju"}]},["cnpQZ","jeorp"], "jeorp", "parcelRequire9e96")
